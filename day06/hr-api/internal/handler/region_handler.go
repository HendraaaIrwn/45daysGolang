...
// GetRegionsWithCountry handles GET /regions/countries
// Currently returns regions without country details (countries not modeled here yet).
...
// GetRegionByIdWithCountry handles GET /regions/:id/countries
// Currently returns region without country details (countries not modeled here yet).
