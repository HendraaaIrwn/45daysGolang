...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserHandphone = field.NewString(tableName, "user_handphone")
	_user.CreatedOn = field.NewTime(tableName, "created_on")
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserHandphone = field.NewString(table, "user_handphone")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["user_handphone"] = u.UserHandphone
