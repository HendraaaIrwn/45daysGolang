...
func newJob(db *gorm.DB, opts ...gen.DOOption) job {
	...
	_job.JobID = field.NewInt32(tableName, "job_id")
	_job.JobTitle = field.NewString(tableName, "job_title")
...
type job struct {
	...
	MinSalary field.Float64
	MaxSalary field.Float64
...
func (j *job) updateTableName(table string) *job {
	...
	j.JobID = field.NewInt32(table, "job_id")
	j.JobTitle = field.NewString(table, "job_title")
...
func (j *job) fillFieldMap() {
	...
	j.fieldMap["job_title"] = j.JobTitle
