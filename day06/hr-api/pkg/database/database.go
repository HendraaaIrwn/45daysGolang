...
import (
	...
	configs "github.com/HendraaaIrwn/hr-restapi/hr-api/internal/config"
...
// AutoMigrate will execute given models
...
func SetupDB() (*gorm.DB, error) {
	...
	dsn := "host=localhost user=postgres password=admin dbname=hr_db_test port=5432 sslmode=disable TimeZone=Asia/Jakarta search_path=public"

	//2. open connection,aktifkan logger
